...
describe.only("getConcessionByID", () => {
    test("getConcessionByID should return the concession object with a matching ID", () => {
        const concessions = [
        ...
        expect(result).toEqual({ id: "0Qs9Yp2NL", name: "Large Popcorn", priceInCents: 1029 })
    })
})